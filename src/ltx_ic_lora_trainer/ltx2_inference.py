...
class LTX2Inferencer:
    ...
    def load_spatial_upsampler(
        ...
        from ltx_ic_lora_trainer.ltx_2.model.upsampler import LatentUpsamplerConfigurator
    ...
    def _apply_distilled_lora(self, multiplier: float = 1.0) -> None:
        ...
        from ltx_ic_lora_trainer.networks import lora_ltx2
    ...
    def _upsample_latents(
        ...
        from ltx_ic_lora_trainer.ltx_2.model.upsampler import upsample_video
