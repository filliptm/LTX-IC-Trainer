        ...
        if load_in_8bit or load_in_4bit:
            ...
            if gemma_weights_path is not None:
                ...
                if gemma_root is not None:
                    ...
                    from ltx_ic_lora_trainer.ltx_2.text_encoders.gemma.fp8_ops import infer_gemma3_config_from_safetensors
                ...
                if keep_fp8:
                    from ltx_ic_lora_trainer.ltx_2.text_encoders.gemma.fp8_ops import replace_linear_with_fp8
