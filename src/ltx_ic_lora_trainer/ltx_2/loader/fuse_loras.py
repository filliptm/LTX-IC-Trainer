...
try:
    ...
    from ltx_ic_lora_trainer.ltx_2.loader.kernels import fused_add_round_kernel

    _HAS_TRITON = True
except Exception:
    triton = None  # type: ignore
    fused_add_round_kernel = None  # type: ignore
    _HAS_TRITON = False
from ltx_ic_lora_trainer.ltx_2.loader.primitives import LoraStateDictWithStrength, StateDict
