...
from ltx_ic_lora_trainer.ltx_2.components.patchifiers import (
    AudioLatentShape,
    AudioPatchifier,
...
from ltx_ic_lora_trainer.ltx_2.components.protocols import Patchifier
from ltx_ic_lora_trainer.ltx_2.types import LatentState, SpatioTemporalScaleFactors
