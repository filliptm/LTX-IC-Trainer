...
from ltx_ic_lora_trainer.utils import huggingface_utils, model_utils, sai_model_spec, train_utils
from ltx_ic_lora_trainer.utils.safetensors_utils import MemoryEfficientSafeOpen, mem_eff_save_file
from ltx_ic_lora_trainer.ltx2_train_network import LTX2NetworkTrainer, ltx2_setup_parser
...
def _collect_motion_attention_modules(
    ...
    from ltx_ic_lora_trainer.ltx_2.model.transformer.attention import Attention
...
def main() -> None:
    ...
    if args.fused_backward_pass:
        ...
        import ltx_ic_lora_trainer.modules.adafactor_fused as adafactor_fused
