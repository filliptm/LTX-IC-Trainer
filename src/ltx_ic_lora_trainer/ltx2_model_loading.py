...
from ltx_ic_lora_trainer.modules.nf4_optimization_utils import apply_nf4_monkey_patch, load_safetensors_with_nf4_optimization, DEFAULT_NF4_BLOCK_SIZE
from ltx_ic_lora_trainer.utils.lora_utils import load_safetensors_with_lora_and_fp8
from ltx_ic_lora_trainer.modules.fp8_optimization_utils import apply_fp8_monkey_patch
from ltx_ic_lora_trainer.modules.w8a8_optimization_utils import apply_w8a8_monkey_patch
...
def load_ltx2_model(
    ...
    **_: Any,
    ...
    from ltx_ic_lora_trainer.networks.lora_ltx2 import LTX2Wrapper
    ...
    if nf4_base:
        ...
        if _pre_quantized:
            ...
            if loftq_init and lora_rank > 0:
                from ltx_ic_lora_trainer.ltx2_quantize_model import loftq_path_for_model
            ...
            from ltx_ic_lora_trainer.modules.nf4_optimization_utils import optimize_state_dict_with_nf4
            ...
            # --- AWQ calibration ---
            if awq_calibration:
                from ltx_ic_lora_trainer.modules.awq_calibration import (
                    get_awq_cache_path,
                    load_awq_scales,
                    save_awq_scales,
            ...
            # --- LoftQ ---
            if loftq_init and lora_rank > 0:
                from ltx_ic_lora_trainer.networks.lora_ltx2 import compute_loftq_from_state_dict
