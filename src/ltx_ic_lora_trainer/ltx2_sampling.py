...
from ltx_ic_lora_trainer.utils.device_utils import clean_memory_on_device
from ltx_ic_lora_trainer.utils import model_utils
from ltx_ic_lora_trainer.base_trainer import load_prompts, should_sample_images
from ltx_ic_lora_trainer.utils.video_io import save_images_grid, save_videos_grid
from ltx_ic_lora_trainer.ltx2_inference import LTX2Inferencer, InferenceConfig
...
class LTX2SamplingMixin:
    ...
    def _get_audio_preview_config(self, args: argparse.Namespace, transformer) -> Dict[str, int | float]:
        ...
        from ltx_ic_lora_trainer.ltx_2.model.audio_vae.audio_vae import LATENT_DOWNSAMPLE_FACTOR
        ...
        *,
        ...
        try:
            ...
            cmd = [
                sys.executable,
                "-m",
                "ltx_ic_lora_trainer.ltx2_audio_preview",
                "--checkpoint",
                checkpoint_path,
                "--input",
                tmp_path,
    ...
    def _override_attention_function(transformer, attention_function):
        from ltx_ic_lora_trainer.ltx_2.model.transformer.attention import Attention, AttentionFunction
    ...
    def _resolve_first_dataset_cache_directory(self, args: argparse.Namespace) -> str:
        from ltx_ic_lora_trainer.dataset import config_utils
        from ltx_ic_lora_trainer.dataset.config_utils import BlueprintGenerator, ConfigSanitizer
    ...
    def _build_text_encoder(self, args: argparse.Namespace, accelerator: Accelerator) -> torch.dtype:
        ...
        from ltx_ic_lora_trainer.ltx_2.loader.single_gpu_model_builder import SingleGPUModelBuilder
        from ltx_ic_lora_trainer.ltx_2.text_encoders.gemma.encoders.av_encoder import (
            AVGemmaTextEncoderModelConfigurator,
            AV_GEMMA_TEXT_ENCODER_KEY_OPS,
        )
        from ltx_ic_lora_trainer.ltx_2.text_encoders.gemma.encoders.base_encoder import module_ops_from_gemma_root
        from ltx_ic_lora_trainer.ltx_2.text_encoders.gemma.encoders.video_only_encoder import (
    ...
    def _load_reference_for_output(
        ...
        from ltx_ic_lora_trainer.dataset.image_video_dataset import VIDEO_EXTENSIONS
    ...
    def _load_and_encode_v2v_reference(
        ...
        from ltx_ic_lora_trainer.ltx_2.loader.single_gpu_model_builder import SingleGPUModelBuilder
        from ltx_ic_lora_trainer.ltx_2.model.video_vae import VideoEncoderConfigurator, VAE_ENCODER_COMFY_KEYS_FILTER
    ...
    def do_inference(
        ...
        from ltx_ic_lora_trainer.ltx_2.types import AudioLatentShape, VideoPixelShape
        ...
        if getattr(args, "sample_disable_flash_attn", True):
            from ltx_ic_lora_trainer.ltx_2.model.transformer.attention import AttentionFunction
        ...
        from ltx_ic_lora_trainer.ltx_2.model.ltx2_scheduler import EulerDiffusionStep, X0PredictionWrapper
        from ltx_ic_lora_trainer.ltx_2.components.schedulers import LTX2Scheduler
        ...
        if _av_bimodal_cfg and audio_latents is not None:
            from ltx_ic_lora_trainer.ltx_2.guidance.perturbations import (
        ...
        if not decode_video:
            ...
            with torch.no_grad():
                ...
                if use_tiled_vae:
                    from ltx_ic_lora_trainer.ltx_2.model.video_vae import TilingConfig, SpatialTilingConfig, TemporalTilingConfig
