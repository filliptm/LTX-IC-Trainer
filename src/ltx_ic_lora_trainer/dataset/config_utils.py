...
from ltx_ic_lora_trainer.dataset.image_video_dataset import DatasetGroup, ImageDataset, VideoDataset, AudioDataset
...
def create_cache_only_dataset_manifest(
    ...
    manifest: dict = {
        "format": "ltx_ic_lora_trainer_dataset_manifest",
        "version": 1,
