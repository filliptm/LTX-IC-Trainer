...
from ltx_ic_lora_trainer.ltx2_text_conditioning import select_video_text_embeds_for_video_mode
...
class PreservationHelper:
    ...
    def _prepare_block_swap(transformer: torch.nn.Module, accelerator: Accelerator) -> None:
        ...
        if hasattr(unwrapped, "prepare_block_swap_before_forward"):
            ...
            offload_logger = logging.getLogger("ltx_ic_lora_trainer.ltx_2.model.transformer.offloading_utils")
